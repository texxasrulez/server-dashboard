...
(function () {
  ...
  function ensureNodes() {
    ...
    pickerForm =
      pickerForm || document.querySelector(".app-header form.theme-picker");
  ...
  function buildDrawer() {
    ...
    html +=
      '<img src="assets/images/mobile-header-logo.png" alt="Logo" style="height:28px">';
    html +=
      '<button class="btn secondary" type="button" id="mdClose">Close</button>';
    html += "</div>";
