...
(function () {
  ...
  function ensureToolbar() {
    ...
    var tools =
      document.querySelector(".audit-toolbar") ||
      create("div", "audit-toolbar");
    if (!tools.parentNode) {
      var head =
        document.querySelector(".modal-tools,.tools,.card-tools") ||
        document.body;
  ...
  document.addEventListener(
    ...
    function (e) {
      var t =
        e.target &&
        e.target.closest &&
        e.target.closest("#aa-scan,#aa-open,#aa-copy");
      if (!t) return;
      e.preventDefault();
