...
return [
  ...
  'features' => [
    '_label' => 'Features',
  ] + \App\Config::featureSchema(),

  'bookmarks' => [
    '_label' => 'Bookmarks',
    'default_source' => ['type' => 'enum','label' => 'Default source','values' => ['local','rounddav'],'value_labels' => ['local' => 'Local','rounddav' => 'RoundDAV']],
    'rounddav' => [
      '_label' => 'RoundDAV',
      'enabled' => ['type' => 'bool','label' => 'Enable RoundDAV source'],
      'base_url' => ['type' => 'url','label' => 'RoundDAV Base URL'],
      'username' => ['type' => 'string','label' => 'RoundDAV Username'],
      'password' => ['type' => 'secret','label' => 'RoundDAV Password'],
      'visibility' => ['type' => 'enum','label' => 'RoundDAV visibility','values' => ['private','shared'],'value_labels' => ['private' => 'Private','shared' => 'Shared']],
    ],
  ],
  ...
  'mail' => [
    ...
    'mail_envelope_from' => ['type' => 'email','label' => 'Envelope From Email'],
  ...
  'ui' => [
    ...
    'header_navigation_mode' => ['type' => 'enum','label' => 'Navigation layout','values' => ['buttons','dropdown','left-sidebar'],'value_labels' => ['buttons' => 'Header buttons','dropdown' => 'Dropdown menu','left-sidebar' => 'Left sidebar']],
