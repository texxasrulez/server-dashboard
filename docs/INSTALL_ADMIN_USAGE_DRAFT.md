...
- docs/USAGE_MAILER.md: URL with Token → `https://<host>/api/mail_test.php?to=you@example.com&token=YOUR_CRON_TO...`
...
- docs/usage_readme.md: Cron helper example → `curl -fsS "https://YOUR-DASHBOARD/api/alerts_eval.php?probe=1"...`
- docs/usage_readme.md: Dry run example → `curl -fsS "https://YOUR-DASHBOARD/api/alerts_eval.php?probe=1&dry=1"...`
