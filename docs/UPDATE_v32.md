...
**What changed**  
The previous script tried to _move_ the card nodes into a new wrapper. On some pages the selector didn’t match your layout, so nodes were detached and nothing rendered.
...
<link
  rel="stylesheet"
  href="assets/css/pages/server_tests.css?v=<?php echo h(BUILD); ?>"
/>
<script
  defer
  src="assets/js/pages/server_tests.js?v=<?php echo h(BUILD); ?>"
></script>
```
