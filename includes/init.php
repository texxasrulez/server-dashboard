...
if (!function_exists("request_ip_in_cidr")) {
    function request_ip_in_cidr(string $ip, string $cidr): bool
    {
        ...
        if (
            $fullBytes > 0 &&
            substr($ipBin, 0, $fullBytes) !== substr($baseBin, 0, $fullBytes)
        ) {
            return false;
        }
        if ($remainBits === 0) {
        ...
        return (ord($ipBin[$fullBytes]) & $maskByte) ===
            (ord($baseBin[$fullBytes]) & $maskByte);
    }
}
...
if (!function_exists("theme_href")) {
    function theme_href(string $rel = ""): string
    {
        ...
        $candidates = [
            [
                "fs" => __DIR__ . "/../assets/css/themes/" . $theme . ".css",
                "web" => "/assets/css/themes/" . $theme . ".css",
            ],
            [
                "fs" =>
                    __DIR__ . "/../assets/css/themes/" . $theme . "/theme.css",
                "web" => "/assets/css/themes/" . $theme . "/theme.css",
            ],
            [
                "fs" => __DIR__ . "/../assets/css/theme.css",
