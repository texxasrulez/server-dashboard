...
<div class="card">
  ...
  <div class="table-scroll" style="margin-top:.65rem;">
    <table class="table proc-table" id="procTable">
      <thead>
        <tr>
          <th data-sort-key="pid" tabindex="0" role="button" aria-sort="none">PID</th>
          <th data-sort-key="user" tabindex="0" role="button" aria-sort="none">USER</th>
          <th data-sort-key="cpu" tabindex="0" role="button" aria-sort="descending">CPU%</th>
          <th data-sort-key="mem" tabindex="0" role="button" aria-sort="none">RSS</th>
          <th data-sort-key="state" tabindex="0" role="button" aria-sort="none">STATE</th>
          <th data-sort-key="cmd" tabindex="0" role="button" aria-sort="none">CMD</th>
        </tr>
      </thead>
