...
$PAGE_CSS = 'assets/css/pages/server_tests.css';
 ...
 <div class="card">
  ...
  <div class="row between">
    ...
    <div class="row">
      ...
      <button class="btn secondary" id="btnHistory">History</button>      <button class="btn secondary" id="btnExportJson" title="Export last results as JSON"><span data-i18n="history.export_json">Export JSON</span></button>      <button class="btn secondary" id="btnExportCsv" title="Export last results as CSV">Export CSV</button>
    </div>
  </div>
  </div>
  <div class="card">
