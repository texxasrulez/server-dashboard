...
?>
  <div class="card">
    <div class="row" style="justify-content:space-between">
      <div style="font-weight:700"><span data-i18n="logs.title">Logs</span></div>
      <div class="row">
  ...
  <button class="btn" id="btnRefresh"><span data-i18n="history.refresh">Refresh</span></button>
  <button class="btn" id="btnAddLog">Add Log</button>
  <a class="btn" id="btnDownload" href="#" download><span data-i18n="history.download">Download</span></a>
  ...
  <div id="logModal" hidden style="position:fixed;inset:0;z-index:1000">
    ...
    <div class="modal-card card" style="position:relative;max-width:920px;margin:8vh auto;padding:1rem">
      ...
      <div class="tablewrap" style="margin-top:.5rem;max-height:40vh;overflow:auto">
        <table id="logCfgTable" class="sortable">
      ...
      <div class="mt-2">
        <div class="row" style="justify-content:space-between;align-items:center">
          ...
          <div class="row">
            <button class="btn" id="mirrorRefresh" type="button"><span data-i18n="history.refresh">Refresh</span></button>
          </div>
        </div>
        <div class="tablewrap" style="margin-top:.5rem;max-height:40vh;overflow:auto">
          <table id="mirrorTable" class="sortable">
  ...
  <div class="card">
    <div class="row" style="justify-content:space-between">
      <div style="font-weight:700"><span data-i18n="history.title">History</span></div>
      <div class="row">
...
(function(){
  ...
  async function refreshFromMirror(){
    ...
    filtered.forEach(r=>{
      ...
      tr.appendChild(document.createElement('td')).textContent = r.ip || '';
